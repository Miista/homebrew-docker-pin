...
// container name.
//
// This is the whole of the decider's impurity: everything else in the package
...
// the detector is watching what the compose file does not describe, or a
